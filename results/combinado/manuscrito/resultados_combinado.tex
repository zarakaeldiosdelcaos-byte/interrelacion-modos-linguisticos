...
%  Corrida completa y verificada del pipeline (Experimento ALC_v5_corregido.R,
%  v5.9, SHA-256 1143b36a…). Origen, relativo a «Analisis agosto v2/»:
...
%     · outputs/tablas/tabla_robustez_modelos.csv           (sensibilidad)
%     · resultados/tablas/datos_completos_ancho.csv         (desagregación por fuente)
%  ADVERTENCIA CENTRAL: el «conjunto de 40» son DOS MUESTRAS INDEPENDIENTES
%  (17 piloto + 23 principal), capturadas en momentos distintos y con
%  instrumentos distintos (la demora y n_palabras solo existen en el principal).
%  No es una sola muestra y así se trata en todo el documento.
